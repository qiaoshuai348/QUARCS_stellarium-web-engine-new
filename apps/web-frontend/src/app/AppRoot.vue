...
.app-root {
  --qs-bg-top: #08111f;
  --qs-bg-bottom: #02060d;
  --qs-surface-0: rgba(192, 205, 228, 0.96);
  --qs-surface-1: rgba(185, 198, 222, 0.92);
  --qs-surface-2: rgba(178, 192, 218, 0.90);
  --qs-surface-3: rgba(168, 184, 214, 0.92);
  --qs-surface-4: rgba(158, 175, 208, 0.94);
  --qs-panel-shadow: rgba(60, 85, 130, 0.28);
  --qs-panel-shadow-soft: rgba(60, 85, 130, 0.16);
  --qs-border-soft: rgba(148, 172, 218, 0.36);
  --qs-border-strong: rgba(125, 158, 215, 0.54);
  --qs-highlight-soft: rgba(255, 255, 255, 0.32);
  --qs-highlight-strong: rgba(255, 255, 255, 0.52);
  --qs-glow-blue: rgba(90, 130, 200, 0.14);
  --qs-glow-cyan: rgba(110, 170, 230, 0.10);
  --qs-text-primary: rgba(22, 38, 65, 0.94);
  --qs-text-secondary: rgba(50, 72, 110, 0.86);
  --qs-text-muted: rgba(88, 115, 158, 0.78);
  --qs-radius-xl: 44px;
  --qs-radius-lg: 28px;
  --qs-radius-md: 20px;
